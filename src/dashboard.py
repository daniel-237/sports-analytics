...
# ═══════════════════════════════════════════════════════════════════════════════
    ...
    insight_card("",  f"<b>{best_att['team']}</b> have the best attack — averaging <b>{best_att['attack']:.2f}</b> goals per game.")
    insight_card("", f"<b>{best_def['team']}</b> have the best defence — conceding only <b>{best_def['defence']:.2f}</b> goals per game.")
